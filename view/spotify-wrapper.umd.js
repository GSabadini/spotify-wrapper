...
var TOKEN_API = 'BQA-kbqie0s7g2oPrFIKknOG-EPKmwioFavMuVtVNYysIs1dbEumyfpcY6beLebu92HaWUbOAN7A_5pr58BWoJI7kUi9CFn3iCyg5ycnjhwWnVez7fuxg-Wo3LxxqY54L1ywjNVkmp-5KBo';
...
var getAlbum = exports.getAlbum = function getAlbum(id) {
  fetch(_config.API_URL + '/albums/' + id, _config.HEADERS).then(_utils2.default);
};

var getAlbums = exports.getAlbums = function getAlbums(ids) {
  fetch(_config.API_URL + '/albums/ids=' + ids, _config.HEADERS).then(_utils2.default);
};

var getAlbumTracks = exports.getAlbumTracks = function getAlbumTracks(id) {
  fetch(_config.API_URL + '/albums/' + id + '/tracks', _config.HEADERS).then(_utils2.default);
};
